...
public class Screen extends JFrame {
    ...
    public void showImage(String f, int height, int width) {
        try {
            ImageIcon imageIcon = new ImageIcon(f);
            StyleConstants.setIcon(this.attr, getResizedImage(imageIcon,height, width));
    ...
    private ImageIcon getResizedImage(ImageIcon imageIcon, int height, int width){
